...
target state, intent dedupe, mutation, and durable ExecutionRecord.
"""
...
def validate_decision(decision: Any, canonical_bytes) -> tuple[bool, str | None, str | None]:
    ...
    if not exact_keys(target, {"kind", "id", "expected_version"}):
        return False, None, None
    if not exact_keys(effect, {"type", "version", "params"}):
        return False, None, None
    if (
...
def install_authority(
    ...
    *,
    ...
    try:
        ...
        conn.commit()
        result.update({"installed": True, "generation": new_generation})
        return result
...
def authorization_request(intent: dict[str, Any], state: dict[str, Any], *, evaluation_time: str, canonical_bytes) -> dict[str, Any]:
    ref = reference_identity("cal.envelope-probe-intent", "rc2", intent["intent_id"], canonical_bytes)
    return {
        ...
        "jurisdiction": {
            "domain": "cal.envelope-probe", "operation": intent["operation"], "scope": "record",
            "target_class": intent["target_kind"], "target_ref": ref,
        },
        "references": [{
            "ref_id": "intent", "kind": "cal.envelope-probe-intent", "version": "rc2",
            "immutable_id": intent["intent_id"], "identity_sha256": ref,
        }],
        "supporting_artifacts": [], "conflicts": [], "residues": [],
    }
    ...
    *,
    ...
    try:
        ...
        record_body = {
            ...
            "authority_state_id": auth_row["authority_state_id"],
            "authority_state_sha256": auth_row["authority_state_sha256"],
            "target_id": TARGET_ID, "target_before_version": INITIAL_VERSION,
            "target_before_state": FROM_STATE, "target_after_version": FINAL_VERSION,
            "target_after_state": TO_STATE, "committed_outcome": "committed",
        }
