...
def main() -> None:
    ...
    if positive_failures:
        ...
        disposition = "SUPPORTED_INDEPENDENT_CONSUMER_CONFORMANCE_RC0"

    result = {
        "schema": "contract-c-cal-v1-parent-consumer-postfreeze-result-v1",
        "disposition": disposition,
        "frozen_consumer": {
            "freeze_commit": "c91b9bb9a0b03522f1cd94da82544fa02e72f862",
            "candidate_commit": "49251b3f8ea19f600249e8189254d257ccd6aa3e",
            "consumer_blob": "3d36881673575adafc42e9a0f9b2b7fae2d5bf9d",
            "test_blob": "1b89b9536106fa66568953d3ff5f8e3e850027b2",
            "freeze_receipt_blob": "c381f36f9d438468e2f8ec956f77317c3486f623",
        },
        "producer_subject": {
